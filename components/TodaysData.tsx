...
export const TodaysData = () => {
  ...
  return (
    <div className='basis-1/2 pt-5 flex-col'>
      <div className="flex-row">
        <div className="flex justify-center mb-3">
          <h1 className='text-2xl text-center rounded text-white p-2 box-decoration-slice bg-gradient-to-r from-purple to-pink'>Today's Results</h1>
        </div>
      </div>
